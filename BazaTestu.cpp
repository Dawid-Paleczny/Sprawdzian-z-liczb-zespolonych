...
static WyrazenieZesp  TestTrudny[] =
  { {{3.4,-5.3}, Op_Dodaj, {-9.7,-2.2}},
    {{-3.3,-6.1}, Op_Odejmij, {6.6,7.9}},
    {{5.4,9.3}, Op_Mnoz, {3,6}},
    {{9,8}, Op_Dziel, {3,4}},
  };
...
/*
 * Funkcja na podstawie podanej w strukturze liczby pytań i poprawnych odpowiedzi podaje wynik w procentach
 */
int PodajWyniki (Wyniki mojewyniki)
{
  return mojewyniki.LiczbaPoprawnych * 100 / mojewyniki.LiczbaPytan;
}
